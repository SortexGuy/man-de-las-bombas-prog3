...
public class App extends Application {
    ...
    /**
    * Inicia la aplicación JavaFX, configurando la escena principal y mostrando la ventana principal.
    * 
    * @param stage El objeto Stage que representa la ventana principal de la aplicación.
    * @throws IOException Si ocurre un error de E/S durante la ejecución de la función.
    */
    @Override
    ...
    */
    ...
    /**
    * Establece la raíz de la escena en la jerarquía FXML cargada desde el archivo FXML dado.
    *
    ...
    *
    * @param fxml La ruta relativa al archivo FXML que se va a cargar (sin la extensión .fxml).
    * @return La jerarquía de nodos cargada desde el archivo FXML.
    * @throws IOException Si ocurre un error de E/S durante la carga del archivo FXML.
    */
