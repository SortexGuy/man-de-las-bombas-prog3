 ...
 * Las celdas de bomba son celdas especiales que pueden explotar después de un cierto tiempo.
 */
public class BombCell extends EmptyCell {
    ...
    public BombCell(Point2D pos, Player player, Level level) {
        ...
        this.player = player;
        this.level = level;
        // Ajustar el rectángulo de colisión de la celda de bomba para que sea más pequeño que el de una celda vacía
        this.collRect = new Rectangle(pos.getX() + 4, pos.getY() + 4, SIZE - 8, SIZE - 8);
    }

    /**
     * Método para actualizar el estado de la celda de bomba en cada fotograma del juego.
     ...
     * @return true si la celda de bomba colisiona con el rectángulo dado, de lo contrario false.
     */
    @Override
